...
<FORM action="v1.php" NAME=cuestionario>
			...
			<?php if(!in_array($randPreg, $pregAgregados)) { ?>
				...
				<?php for($res = 0; $res < 4; $res++) { ?>
					...
					<?php if(!in_array($randRes, $resAgregados)) { ?>
						...
						<tr><td>
							<input type="radio" name="res<?php echo $randPreg."_".$randRes;?>" value="res<?php echo $randPreg."_".$randRes;?>"/>
	...
	<center>
				<a href="index2.html" title=""><img src="img/ini.jpg"  WIDTH=100 HEIGHT=80 border="0"></a>
                </form><a href="menualu1.html" title><img align="left" src="img/volver.png" width=130 height=100 border="0"></a></div>
